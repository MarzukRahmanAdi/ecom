...
<section class="product-tab-section section-padding bg-light">
    <div class="container">
        ...
        <div class="tab-content tabular-product">
            ...
            @else
            <p style="text-align: center;">You need to <br> <button class="btn loginbtn"  style="background-color: transparent; text-align:center !important; color:black !important;">log in</button> <br> to add items to the cart.</p>
            @endif
                                    </div>
                                    <a href="#">
